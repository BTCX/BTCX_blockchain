...
class ValidateAddress(APIView):
    ...
    def post(self, request):
        ...
        if post_serializers.is_valid():
            ...
            try:
                ...
                log_info(log, "Part of wallet is", part_of_wallet if part_of_wallet != "" else "Not part of any wallet.")
                validate_address_response = self.create_validate_address_response_and_log(log_info,
                ...
                validate_address_response = self.create_validate_address_response_and_log(log_error,
                                                                                          error_message,
                                                                                          ex,
                                                                                          is_valid=is_valid,
                                                                                          is_mine=is_mine,
    ...
    def create_validate_address_response_and_log(self, log_function, log_message, log_item, is_valid, is_mine,
        ...
        validate_address_response = validate_address.ValidateAddressResponse(is_valid=is_valid,
                                                                        is_mine=is_mine,
