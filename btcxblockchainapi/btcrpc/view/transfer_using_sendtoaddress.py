            ...
            try:
                if semaphore.acquire_if_released(log):
                    for transfer in transfer_list:
                        ...
                        if to_address_is_valid:
                            try:
                                ...
                                response = \
                                    transfers_using_sendtoaddress.TransferInformationResponse(
                                        currency=currency,
                    ...
                    transfers_response = transfers_using_sendtoaddress.TransfersInformationResponse(
                        ...
                        error_message="Semaphore is already acquired, wait until semaphore"
                                      " is released.")
                ...
                if serr.errno != errno.ECONNREFUSED:
                    ...
                    transfers_response = transfers_using_sendtoaddress.TransfersInformationResponse(
                        transfers=response_list, chain=chain.value, error=1,
                        error_message="Connection refused error, check if the wallet"
                                      " node is down.")
