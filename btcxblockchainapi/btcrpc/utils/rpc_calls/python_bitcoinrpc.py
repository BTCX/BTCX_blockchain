...
class PythonBitcoinRpc(RPCCall):
    ...
    def list_received_by_address(
        self, address, confirmations=0, include_empty=False, include_watchonly=False
    ):
        return self.access.listreceivedbyaddress(
            confirmations, include_empty, include_watchonly, address
        )
